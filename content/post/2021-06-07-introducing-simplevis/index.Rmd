---
title: simplevis - simple ggplot2 visualisation with less brainpower and typing  
author: 'David Hodge'
date: '2021-06-07'
...
More blogs to come on `simplevis` methods for adjusting colours, titles and scales, filtering out NA values, and working with `ggplotly` and `leaflet`. In the meantime, see the vignette and articles on the [simplevis website](https://statisticsnz.github.io/simplevis/).
